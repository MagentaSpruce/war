  ...
  return (
    ...
    >
      <div className="lg:pt-10">
        ...
        <h3 className="text-center p-2 md:w-[80%] md:mx-auto">
          Nobody from the South African Embassy has visited, written to, or even
          spoken to Ashley Oosthuizen once since this entire nightmare began.
          They have ignored countless request for both aid and information.
        </h3>
      </div>
