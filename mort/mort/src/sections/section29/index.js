const Section29 = () => {
  return (
    <div
      className="bg-slate-700 text-white font-economica
        xxs:h-[160vh] 
        xs:h-[150vh] 
        ...
        <h3 className="text-center   p-2 md:w-[80%] md:mx-auto ">
          ...
          <button className="hover:scale-105 transition-all active:scale-100 block mx-auto xxs:mt-2 ">
            ...
            <a
              ...
              className="text-center text-3xl bg-red-600 px-2 py-1 rounded-lg text-white  mb-4"
              target="_blank"
              rel="noreferrer"
            >
              YouTube Channel
        ...
        <h3 className="text-center p-2 md:w-[80%] md:mx-auto">
          ...
          <button className="hover:scale-110 transition-all active:scale-100 block mx-auto xxs:mt-2">
            ...
            <a
              ...
              className="text-center text-3xl bg-sky-500 px-2 py-1 rounded-lg text-white  mb-4"
              target="_blank"
              rel="noreferrer"
            >
              Twitter
