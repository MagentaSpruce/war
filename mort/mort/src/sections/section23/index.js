...
<h3 className="text-center p-2 font-economica"> It looks much better to have the drugs coming from somewhere else. Tristan used Hot in the Biscuit for less than 6 weeks to import drugs. He used Panyadee for well more than a hundred. So why is Ashley the one in chains?</h3>

<h3 className="text-center p-2 font-economica">Why wasn't Panyadee charged with importation? Did they not accept packages of drugs and then later also open them as well? Ashley never tampered with the package t all. So one parties ignorance is lawful and the other parties ignorance is not? Where is the reason?</h3>
