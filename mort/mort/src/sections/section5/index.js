...
<img src="./images/sergey2.jpg" alt="Sergey Requesting Payment" srcset="" 
  ...
  lg:h-[60vh]"
/>
<h3 className="text-center p-2 font-economica">He was given cash in the teacher's office during school hours, usually at lunch, where he would then transfer the BTC which can be traced to his bitkub account.</h3>
</div>
...
<img src="./images/sergey3.jpg" alt="Part of One Order" 
   ...
   lg:h-[25vh]"
/>
<h3 className="text-center p-2 font-economica">Then the same BTC was soon after used to import drugs to the school as shown below.</h3>
</div>
</div>
    )
}
